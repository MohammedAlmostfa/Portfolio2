    ...
    <section className="relative min-h-screen flex items-center pt-24 sm:pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* العمود الأيسر - أنيميشن متتابع (بدون تغيير) */}
          <motion.div 
            className="relative"
          ...
          >
            <div className="space-y-6 sm:space-y-8">
              ...
              <motion.div variants={fadeInUp} className="inline-flex items-center px-3 py-1 rounded-full bg-surface-container-high border border-outline-variant/30 gap-2">
              ...
              >
                {[
                  ...
                  >
                    <div className="text-3xl sm:text-4xl font-bold text-white font-headline">{stat.value}</div>
                    <div className="text-xs sm:text-sm text-on-surface-variant font-label uppercase tracking-tighter">{stat.label}</div>
                  </motion.div>
                ))}
              </motion.div>
            </div>
